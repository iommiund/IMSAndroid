...
public class CollectActivity extends AppCompatActivity {
    ...
    public void collectResource(View view) {
        String orderId = editTextOrderId.getText().toString();
        String resource = textViewResource.getText().toString();
        String type = "collect";

        BackgroundWorkerCollect backgroundWorkerCollect= new BackgroundWorkerCollect(this);
        backgroundWorkerCollect.execute(type, orderId, resource);
    }
}
